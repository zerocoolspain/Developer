...
##grep -Ewv "root|addm|addmusr|ansibleu|ccs_mon" saca_info_usuario.csv > saca_info_usuario.csv_TMP
##grep -wv "root" saca_info_usuario.csv > saca_info_usuario.csv_TMP
...
mv saca_info_usuario.csv escaneo_usuarios.csv
